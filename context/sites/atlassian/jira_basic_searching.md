...
- If you are comfortable with the Jira Query Language (JQL), you may want to use [advanced search](https://confluence.atlassian.com/servicemanagementserver103/advanced-searching-1488596757.html) instead. This search is more powerful than than the basic search.

*Screenshot: Basic search*

*![](https://confluence.atlassian.com/servicemanagementserver103/files/1488596727/1488596728/1/1649875008986/BasicSearching.png)*
...
2. Enter the criteria for the search. You can search against specific fields and/or search for specific text.
	- If you are searching against a field and can't find the field you want, or the field is displaying greyed out text, see the [Troubleshooting section](https://confluence.atlassian.com/servicemanagementserver103/#Basicsearching-troubleshooting) below.
	- If you are searching for text, you can use special characters and modifiers in your search text, such as wildcards and logical operators. See [Search syntax for text fields](https://confluence.atlassian.com/servicemanagementserver103/search-syntax-for-text-fields-1488596778.html).
...
Saved searches (also known as [filters](https://confluence.atlassian.com/servicemanagementserver103/saving-your-search-as-a-filter-1488596780.html)) are shown in the left panel, when using basic search. If the left panel is not showing, hover your mouse over the left side of the screen to display it.
...
![List of saved filters.](https://confluence.atlassian.com/servicemanagementserver103/files/1488596727/1488596729/1/1649856163565/filter_nav.png)

List of saved filters.

## Troubleshooting

[Why can't I find the field I want to choose?](https://confluence.atlassian.com/servicemanagementserver103/#)
...
[Why are the field criteria displaying in grey text?](https://confluence.atlassian.com/servicemanagementserver103/#)
...
[Why is there a red exclamation mark in my field?](https://confluence.atlassian.com/servicemanagementserver103/#)
...
[Why don't my search results automatically update?](https://confluence.atlassian.com/servicemanagementserver103/#)
...
- [Saving your search as a filter](https://confluence.atlassian.com/servicemanagementserver103/saving-your-search-as-a-filter-1488596780.html)
- [Working with search results](https://confluence.atlassian.com/servicemanagementserver103/working-with-search-results-1488596842.html) — find out how to use the issue navigator, export your search results, bulk modify issues, and share your search results.
